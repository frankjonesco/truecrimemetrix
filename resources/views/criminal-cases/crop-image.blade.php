    ...
    <div class="container">
        ...
        <div class="flex gap-12">
            <div class="w-2/3 bg-yellow-500">
                <img id="image" src="{{$criminal_case->getFullImage()}}" alt="" style="height:500px;" class="w-1/3">
            </div>

            <div class="w-1/3">
                <form action="{{url('dashboard/criminal-cases/'.$criminal_case->hex.'/images/render')}}" method="POST" class="flex justify-between">
                    @csrf
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <div>
                            <a href="/dashboard/criminal-cases/{{$criminal_case->hex}}/images/upload">
