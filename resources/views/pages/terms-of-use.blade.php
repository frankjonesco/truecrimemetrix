    ...
    <div class="document-card">
        ...
        <div id="overview" class="section">
            ...
            <div class="sub-section">
                ...
                <p class="pb-4 bold text-red-700">The User must read this document carefully.</p>

                <p class="bold">This Application is provided by:</p>
                ...
                <p class="bold">                
                    ...
                    Email: <a href="mailto:hello@truecrimemetrix.com">hello@truecrimemetrix.com</a>
                </p>
            </div>
        ...
        <div id="information" class="section">
            ...
            <div class="sub-section">
                ...
                <p>MyTravelBlog is an award winning blog, founded in 2014, which explores the best places and ways to travel while earning a passive income. The information and instructions contained in this blog are intended to be broadly entertaining and helpful rather than prescriptive on an individual level.</p>
        ...
        <div id="termsOfUse" class="section">
            ...
            <div class="sub-section">
                ...
                <p class="bold">By using this Application, Users confirm to meet the following requirements:</p>
            ...
            <div class="sub-section">
                ...
                <p>To use the Service Users may register or create a User account, providing all required data or information in a complete and truthful manner.</p>
        
                <p>Users may also use the Service without registering or creating a User account, however, this may cause limited availability of certain features or functions.</p>
            ...
            <div class="sub-section">
                ...
                <p class="bold">Users can terminate their account and stop using the Service at any time by doing the following:</p>
            ...
            <div class="sub-section">
                ...
                <h3>Rights regarding content provided by Users</h3>
            ...
            <div class="sub-section">
                ...
                <p class="bold">However, the Owner reserves the right to remove, delete, block or rectify such content at its own discretion and to, without prior notice, deny the uploading User access to this Application:</p>
        ...
        <div id="liability" class="section">
            ...
            <div class="sub-section">
                ...
                <p class="sub-heading">Indemnification</p>
        ...
        <div id="usUsers" class="section">
            ...
            <div class="sub-section">
                ...
                <h3 class="first">Disclaimer of Warranties</h3>
            ...
            <div class="sub-section">
                ...
                <p class="bold">To the maximum extent permitted by applicable law, in no event shall the Owner, and its subsidiaries, affiliates, officers, directors, agents, co-branders, partners, suppliers and employees be liable for</p>
            ...
            <div class="sub-section">
                ...
                <p class="bold">The User agrees to defend, indemnify and hold the Owner and its subsidiaries, affiliates, officers, directors, agents, co-branders, partners, suppliers and employees harmless from and against any and all claims or demands, damages, obligations, losses, liabilities, costs or debt, and expenses, including, but not limited to, legal fees and expenses, arising from</p>
        ...
        <div id="commonProvisions" class="section">
            ...
            <div class="sub-section">
                ...
                <p>Users may not reproduce, duplicate, copy, sell, resell or exploit any portion of this Application and of its Service without the Owne's express prior written permission, granted either directly or through a legitimate reselling programme.</p>
            ...
            <div class="sub-section">
                ...
                <h3>Exception for European Consumers</h3>
            ...
            <div class="sub-section">
                ...
                <p>Each party specifically waives any right to trial by jury in any court in connection with any action or litigation. Any claims under these terms shall proceed individually and no party shall join in a class action or other proceeding with or on behalf of others.</p>
            ...
            <div class="sub-section">
                ...
                <p class="sub-heading">Surviving provisions</p>
