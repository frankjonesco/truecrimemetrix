<x-layout>
    <div class="container">
        <h1 class="text-center my-10">Sign up</h1>
        ...
        <form action="/users/authenticate" method="post" class="mx-auto w-2/5 mt-16 flex flex-col">
            ...
            <input type="text" name="password_confirmation" class="w-full text-3xl text-thin placeholder-gray-300 placeholder-thin text-center !mb-20" placeholder="Confirm password">
            <input type="checkbox" name="agree_terms" value="1" class="mt-2 ml-2 mr-5 w-6 h-6 text-lg font-medium !outline-red-500 accent-lime-400 text-gray-900">
